...
beach_water_cleaned_data$`E. Coli Levels (# colonies/100mL)` >= min_ecoli_level & 
  beach_water_cleaned_data$`E. Coli Levels (# colonies/100mL)` <= max_ecoli_level
...
beach_water_cleaned_data$`E. Coli Level (# colonies/100mL)` |> class() == "integer"
